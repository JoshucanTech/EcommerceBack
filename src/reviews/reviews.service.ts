...
export class ReviewsService {
  ...
  async update(id: string, updateReviewDto: UpdateReviewDto, user: any) {
    ...
    if (updateReviewDto.rating !== undefined) {
      ...
      await this.updateProductAndVendorRatings(review.productId, product.vendorId)
    }
  ...
  async remove(id: string, user: any) {
    ...
    // Update product and vendor ratings
    await this.updateProductAndVendorRatings(review.productId, review.product.vendorId)

    return { message: "Review deleted successfully" }
  }

  private async updateProductAndVendorRatings(productId: string, vendorId: string) {
