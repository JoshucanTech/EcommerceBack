...
export class ProductsController {
  ...
  @ApiQuery({ name: "category", required: false, type: String, description: "Category ID or slug" })
  @ApiQuery({ name: "vendor", required: false, type: String, description: "Vendor ID or slug" })
  ...
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  @ApiResponse({ status: 403, description: status: 401, description: 'Unauthorized'})
  @ApiResponse({ status: 403, description: 'Forbidden - Insufficient permissions' })
  @ApiResponse({ status: 404, description: 'Product not found' })
