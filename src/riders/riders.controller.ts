...
export class RidersController {
  ...
  @ApiResponse({ status: 409, description: "User already has an application or is a rider" })
  apply(@Body() createRiderApplicationDto: CreateRiderApplicationDto, @CurrentUser() user) {
  ...
  @ApiResponse({ status: 200, description: "Returns paginated rider applications" })
  @ApiResponse({ status: 401, description: "Unauthorized" })
  ...
  @ApiResponse({ status: 200, description: 'Returns the user\'s rider application' })
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  ...
  @ApiResponse({ status: 403, description: "Forbidden - Insufficient permissions" })
  @ApiResponse({ status: 404, description: "Application not found" })
  updateApplication(@Param('id') id: string, @Body() updateRiderApplicationDto: UpdateRiderApplicationDto) {
  ...
  @ApiQuery({ name: "latitude", required: true, type: Number, description: "Delivery location latitude" })
  @ApiQuery({ name: "longitude", required: true, type: Number, description: "Delivery location longitude" })
  @ApiQuery({ name: "radius", required: false, type: Number, description: "Search radius in kilometers" })
  @ApiResponse({ status: 200, description: "Returns available riders near the location" })
  findAvailable(
  ...
  @ApiResponse({ status: 403, description: "Forbidden - Insufficient permissions" })
  @ApiResponse({ status: 404, description: "Rider not found" })
  updateLocation(@CurrentUser() user, @Body() updateLocationDto: UpdateLocationDto) {
  ...
  @ApiResponse({ status: 403, description: "Forbidden - Insufficient permissions" })
  @ApiResponse({ status: 404, description: "Rider not found" })
  toggleAvailability(@CurrentUser() user, @Body() body: { isAvailable: boolean }) {
